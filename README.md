...
| -------- | --------------- | ---------------------- | --------------- | ---------------- |
| **JSON** | 4.4M URLs/sec   | API responses, configs | 1KB - 20MB      | M1 Mac, Intel i7 |
| **CSS**  | 2.4M URLs/sec   | Stylesheets, assets    | 1KB - 20MB      | M1 Mac, Intel i7 |
| **JS**   | 1.2M URLs/sec   | JavaScript, APIs       | 1KB - 30MB      | M1 Mac, Intel i7 |
| **MD**   | 420K URLs/sec   | Documentation, READMEs | 1KB - 15MB      | M1 Mac, Intel i7 |
| **HTML** | 386K URLs/sec   | Web pages, templates   | 1KB - 25MB      | M1 Mac, Intel i7 |
